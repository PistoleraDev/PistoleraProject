    ...
    if part=='hat'
        {
            ...
            case 1:
                ...
                break;
            case 2:
                    anim_x+=10*(240/room_speed)*(anim_countdown/anim_duration);
                    target_y=0;
                    anim_spriteangle-=random_range(20,30)*(240/room_speed)*(anim_countdown/anim_duration);
                    target_xscale=0.9;
                    target_yscale=0.9;
                break;
            }
