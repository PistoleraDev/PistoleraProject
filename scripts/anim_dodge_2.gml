...
if anim_countdown>0
{
    ...
    if part=='body'
        {
            ...
            anim_spriteangle-=(720/anim_duration)*global.delta;
    ...
    //show_debug_message('A: '+string(d_rot)+' B: '+string(angle_difference(anim_spriteangle,target_spriteangle)/diff));
